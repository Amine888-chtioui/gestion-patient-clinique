// src/components/doctor-dashboard/DoctorSidebar.jsx - Version optimisée
import React from "react";
import { DASHBOARD_TABS } from "../../constants/doctorDashboard";
...
const DoctorSidebar = ({ 
  ...
  const NavItem = ({ item }) => (
    <li className={activeTab === item.id ? "active" : ""}>
