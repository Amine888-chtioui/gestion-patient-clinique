...
const MedicalRecordForm = ({ 
  ...
  const handleSubmit = (e) => {
    ...
    // Dans une implémentation réelle, il faudrait gérer l'upload des fichiers
    const recordData = {
      ...formData,
    ...
    <div className="medical-record-form-container">
      <div className="form-header">
        <div className="patient-info">
          ...
          {appointment && (
            <p>Rendez-vous du <strong>{appointment.date}</strong> à <strong>{appointment.time}</strong></p>
          )}
        </div>
      </div>
